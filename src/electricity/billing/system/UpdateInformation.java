...
public class UpdateInformation extends JFrame implements ActionListener{
   ...
   public void actionPerformed(ActionEvent ae) {
    if ("Update".equals(ae.getActionCommand())) { // Correct comparison
        ...
        try {
            Conn c = new Conn(); // Assuming Conn is a class for database connection
            // Corrected SQL query
            c.s.executeUpdate("UPDATE customer SET address = '" + address + 
                              "', city = '" + city + 
                              "', state = '" + state + 
                              "', email = '" + email + 
                              "', phone = '" + phone + 
        ...
        setVisible(false); // Close the window for other actions
    }
}
