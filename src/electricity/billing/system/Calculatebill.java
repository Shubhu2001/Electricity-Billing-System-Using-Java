...
public class Calculatebill extends JFrame implements ActionListener{
    ...
    JTextField tfname ,tfaddress , tfstate ,tfunits ,tfmail ,tfphone;
    JButton next,cancle;
    JLabel Iblname,lbladdress,lblname;
    ...
    Calculatebill(){
        ...
        lblname = new JLabel(""); // Ensure consistent naming
        ...
        cancle.setBounds(270, 350, 100, 30);
    ...
    if (ae.getSource() == next) {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                totalbill += Integer.parseInt(rs.getString("fixed_tax")); // Removed trailing space
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
